...
function Landing() {
	...
	return (
		<section className="relative mt-4 xl:mx-[102px]">
			...
			<div className="absolute -right-2/4 top-0 -z-10 hidden h-[416px] w-[416px] animate-pulse rounded-full bg-yellow-500/50 blur-3xl md:block"></div>
		</section>
	);
}
